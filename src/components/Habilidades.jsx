...
import { cvData } from '../data'; // Importa los datos de tu CV
        ...
        <p className="lead text-dark text-justify">
          {integracionHumanoIA.map((item, index) => (
            <React.Fragment key={index}>
              {item.texto && <span className="fw-bold">{item.texto}</span>} {item.detalle}
              <br />
            </React.Fragment>
          ))}
        </p>
...
export default Habilidades; // ¡¡¡ESTA LÍNEA ES CRÍTICA Y DEBE ESTAR AL FINAL EXACTAMENTE ASÍ!!!
